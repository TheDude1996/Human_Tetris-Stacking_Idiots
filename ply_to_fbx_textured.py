...
Voraussetzungen:
  - Blender 3.x oder 4.x (getestet mit Cycles als Bake-Engine)
...
def build_vertex_color_material(obj):
    ...
    vcol.location = (-200, 0)
    # Name der Vertex-Color-Schicht des importierten Meshes uebernehmen
...
def process_file(filepath, output_dir, bake_size, margin):
    ...
    if not obj.data.vertex_colors:
        print(f"  Warnung: {name} hat keine Vertex-Colors, ueberspringe Textur-Bake.")
    else:
        ensure_uv_map(obj)
